...
--- stop (D.5.2) ---
7. L.2.2        geometry_registry (later — D.5.3)
...
```text
Evidence & Hypothesis Engine (D.5.2)
  R.2.1C facts → R.2.1D EngineeringFacts (run-scoped)

Later milestones
  → L.2.2 → R.3 → … → V.B.1 Excel
```
