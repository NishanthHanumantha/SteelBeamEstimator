...
Runner for Phase R.2.0 â€” MTEXT Engineering Text Recovery Engine
MODEL_VERSION: 7.9.0

Usage (from project root):
    python Version8/Run_PY/run_phase_r20_mtext_recovery.py
"""
...
_PKG_DIR = Version8_SRC / "PhaseR2.0_mtext_engineering_text_recovery"
pkg_name = "PhaseR20"
...
OUTPUT_DIR = Version8_ROOT / "data" / "output" / "PhaseR2.0_mtext_engineering_text_recovery"
