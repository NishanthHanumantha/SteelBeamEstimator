...
- **RULE_1** (All R.1 beams converted): PASS — converted=65
- **RULE_2** (EngineeringBarModel created): PASS — beams=65
...
- **RULE_10** (62 beams propagate to production): PASS — beams_reaching_steel=62

## Propagation Statistics

- Engineering bars created: 226
- Propagation: 100.0%
- Propagation loss: 0

## Before vs After

- beams_reaching_steel: 5 -> 62
- beams_reaching_bbs: 5 -> 62
- beams_reaching_excel: 5 -> 62
