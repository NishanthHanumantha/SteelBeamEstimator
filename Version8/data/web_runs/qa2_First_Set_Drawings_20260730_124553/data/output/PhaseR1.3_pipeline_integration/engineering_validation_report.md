...
- **RULE_1** (All R.1 beams converted): FAIL — converted=18
- **RULE_2** (EngineeringBarModel created): PASS — beams=18
...
- **RULE_10** (62 beams propagate to production): FAIL — beams_reaching_steel=18

## Propagation Statistics

- Engineering bars created: 54
- Propagation: 100.0%
- Propagation loss: 0

## Before vs After

- beams_reaching_steel: 5 -> 18
- beams_reaching_bbs: 5 -> 18
- beams_reaching_excel: 5 -> 18
