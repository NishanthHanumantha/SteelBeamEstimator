...
PRODUCTION_STAGES: List[dict] = [
    ...
    },
    {
        ...
        "expected_outputs": [
            "Version6/data/output/PhaseSI.0_stirrup_recovery/beam_reinforcement_models.json"
        ],
    },
...
VB1_OUTPUTS = [
    "Version6/data/output/Production_Output/Estimation_Output.xlsx",
    "Version6/data/output/Production_Output/production_statistics.json",
    "Version6/data/output/Production_Output/engineering_totals.json",
    "Version6/data/output/Production_Output/steel_weight_summary.json",
    "Version6/data/output/Production_Output/bbs_summary.json",
]
