...
Execute the complete production pipeline (MODEL_VERSION 6.6.3) on Version7.
...
# ------------------------------------------------------------------
# Full production pipeline for MODEL_VERSION 6.6.3 on Version7.
...
class Benchmark2PipelineRunner:
    """
    Execute the complete Version7 production pipeline and capture stage metrics.
