...
_OUT  = _ROOT / "Version7/data/output/Production_Output"
...
_SI1_STATS = (
    _ROOT
    / "Version7/data/output/PhaseSI.1_stirrup_improvement/stirrup_statistics.json"
)
# SI.0 artefact — recovery summary
_SI0_SUMM = (
    _ROOT
    / "Version7/data/output/PhaseSI.0_stirrup_recovery/phase_si0_summary.json"
)
