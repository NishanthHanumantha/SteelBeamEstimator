...
VROOT1_OUTPUT = WORKSPACE / "Version7/data/output/PhaseVROOT.1_dynamic_pipeline_initialization"
BENCH2_FOLDER = WORKSPACE / "Version7/data/Benchmark_Set_2"
OUTPUT_DIR    = WORKSPACE / "Version7/data/output/PhaseVROOT1_Verification"
...
def rule6_drawing_path_validation(report: dict, registry: dict) -> dict:
    """Confirm drawing_path points ONLY to Version7/data/Benchmark_Set_2/."""
    norm_bench2 = _norm(str(BENCH2_FOLDER))
    violations  = []
