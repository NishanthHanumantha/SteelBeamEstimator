...
Runner for Phase R.2.1A — Engineering Semantic Dictionary Engine
MODEL_VERSION: 7.10.0 — READ-ONLY FOUNDATION

Usage (from project root):
    python Version7/Run_PY/run_phase_r21a_semantic_dictionary.py
"""
...
_PKG_DIR = VERSION7_SRC / "PhaseR2.1A_engineering_semantic_dictionary"
pkg_name = "PhaseR21A"
...
OUTPUT_DIR = (
    VERSION7_ROOT / "data" / "output" / "PhaseR2.1A_engineering_semantic_dictionary"
)
