...
def firewall_check(version10_root: Path) -> Dict[str, Any]:
    ...
    for path in src.rglob("*.py"):
        ...
        if "PhaseP254_" in rel or "PhaseP255_" in rel or "PhaseP256_" in rel or "PhaseP257_" in rel or "PhaseP258_" in rel or "PhaseP259_" in rel or "PhaseP2510_" in rel or "PhaseP2511_" in rel or "PhaseP253_" in rel:
            continue
        try:
