"""Assemble VisionGateDecision records from production features + P2.6.4 rules."""
...
def build_gate_decision(
    *,
    ...
    skip_keys = ("score_beam_reasons", "r13_summary", "per_annotation_coverage")
    return {
        "beam_id": beam_id,
        "region_id": region_id,
        "set_key": set_key,
        ...
        "production_features": {k: feat[k] for k in feat if k not in skip_keys},
        "per_annotation_coverage": feat.get("per_annotation_coverage") or [],
        "longitudinal_coverage": feat.get("longitudinal_coverage"),
        "coverage_conditions": feat.get("coverage_conditions") or [],
        "role_gap_status": feat.get("role_gap_status"),
        "role_gap_reason": feat.get("role_gap_reason"),
