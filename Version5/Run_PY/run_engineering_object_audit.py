"""Phase QA.COVERAGE.4 — Engineering Object Creation Audit runner."""
...
from src.engineering_object_audit.audit_engine import EngineeringObjectAuditEngine


def run() -> int:
    project_root = Path.cwd()
    engine = EngineeringObjectAuditEngine(project_root)
    result = engine.run()
