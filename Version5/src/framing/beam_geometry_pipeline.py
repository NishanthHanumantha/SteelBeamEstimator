...
class BeamGeometryPipeline:
    ...
    def run(self) -> Dict[str, Any]:
        ...
        specification_validation = model.get("specification_validation", {})
        specification_reference_validation = model.get("specification_reference_validation", {})
        geometry_validation = model.get("geometry_validation", {})
        ...
        self._outputs.ensure_phase_h_subdirs()
        self._outputs.ensure_phase_i_subdirs()
        ...
        self._write_json(
            self._outputs.phase_h_1_engineering_specifications_export,
            {
                "phase": "Phase H.1",
                "specification_count": len(model.get("engineering_specifications", [])),
                "specifications": model.get("engineering_specifications", []),
            },
        )
        self._write_json(
            self._outputs.phase_h_1_specification_registry_export,
            model.get("specification_registry", {}),
        )
        self._write_json(
            self._outputs.phase_h_1_specification_summary_export,
            model.get("specification_summary", {}),
        )
        self._write_json(
            self._outputs.phase_h_1_specification_validation_export,
            specification_validation,
        )
        self._write_json(
            self._outputs.phase_h_1_reference_contract_export,
            model.get("reference_contract", {}),
        )
        self._write_json(
            self._outputs.phase_h_1_specification_reference_validation_export,
            specification_reference_validation,
        )
        self._write_json(
            self._outputs.phase_h_2_geometry_associations_export,
            {
                "phase": "Phase H.2",
                "association_count": len(model.get("geometry_associations", [])),
                "associations": model.get("geometry_associations", []),
            },
        )
        self._write_json(
            self._outputs.phase_h_2_geometry_registry_export,
            model.get("geometry_registry", {}),
        )
        self._write_json(
            self._outputs.phase_h_2_geometry_summary_export,
            model.get("geometry_summary", {}),
        )
        self._write_json(
            self._outputs.phase_h_2_geometry_validation_export,
            geometry_validation,
        )
        self._write_json(
            self._outputs.phase_i_1_calculation_contexts_export,
            {
                "phase": "Phase I.1",
                "context_count": len(model.get("calculation_contexts", [])),
                "contexts": model.get("calculation_contexts", []),
            },
        )
        self._write_json(
            self._outputs.phase_i_1_calculation_context_registry_export,
            model.get("calculation_context_registry", {}),
        )
        self._write_json(
            self._outputs.phase_i_1_calculation_context_summary_export,
            model.get("calculation_context_summary", {}),
        )
        self._write_json(
            self._outputs.phase_i_1_calculation_context_validation_export,
            calculation_context_validation,
        )
        self._write_json(
            self._outputs.phase_i_2_reinforcement_objects_export,
            {
                "phase": "Phase I.2",
                "bar_count": len(model.get("reinforcement_bars", [])),
                "group_count": len(model.get("reinforcement_groups", [])),
                "bars": model.get("reinforcement_bars", []),
                "groups": model.get("reinforcement_groups", []),
            },
        )
        self._write_json(
            self._outputs.phase_i_2_reinforcement_registry_export,
            model.get("reinforcement_registry", {}),
        )
        self._write_json(
            self._outputs.phase_i_2_reinforcement_summary_export,
            model.get("reinforcement_summary", {}),
        )
        self._write_json(
            self._outputs.phase_i_2_reinforcement_validation_export,
            reinforcement_validation,
        )
        self._write_json(
            self._outputs.phase_i_2_1_reinforcement_readiness_export,
            model.get("reinforcement_readiness", {}),
        )
        self._write_json(
            self._outputs.phase_i_2_1_reinforcement_readiness_summary_export,
            model.get("reinforcement_readiness_summary", {}),
        )
        self._write_json(
            self._outputs.phase_i_2_1_reinforcement_readiness_validation_export,
        ...
        return {
            ...
            "specification_reference_validation": specification_reference_validation,
