...
PHASE_FILE_HINTS = {
    RootCause.EXCEL_MAPPING: ("I.17", "Version5/src/excel_export/excel_export_builder.py"),
    RootCause.DISPLAY_ORDER: ("I.15", "Version5/src/engineering_calculations/beam_schedule/beam_schedule_types.py"),
    RootCause.ROW_INSERTION: ("I.17", "Version5/src/excel_export/excel_export_builder.py"),
    RootCause.TEMPLATE_LAYOUT: ("I.17", "Version5/src/excel_export/excel_export_builder.py"),
    RootCause.ENGINEERING_REPORT: ("I.16", "Version5/src/engineering_reports/engineering_report_builder.py"),
    RootCause.BEAM_SCHEDULE: ("I.15", "Version5/src/engineering_calculations/beam_schedule/beam_schedule_builder.py"),
    RootCause.MATERIAL: ("I.14", "Version5/src/engineering_calculations/material_quantification/material_builder.py"),
    RootCause.QUANTITY: ("I.13", "Version5/src/engineering_calculations/quantity/quantity_builder.py"),
    RootCause.STEEL_WEIGHT: ("I.11", "Version5/src/engineering_calculations/steel_weight/steel_weight_builder.py"),
    RootCause.BBS: ("I.10", "Version5/src/engineering_calculations/bbs/bbs_builder.py"),
    RootCause.ENGINEERING_CALCULATION: ("I.6-I.11", "Version5/src/engineering_calculations/"),
    RootCause.PARSER: ("G/H", "Version5/src/reinforcement/"),
    RootCause.DRAWING_DATA: ("Drawing", "Version5/data/framing/"),
