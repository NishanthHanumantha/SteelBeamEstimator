...
PHASE_H = "phase_h"
PHASE_H_1_ENGINEERING_SPECIFICATIONS = "h_1_engineering_specifications"
PHASE_H_2_GEOMETRY_ASSOCIATION = "h_2_geometry_association"
PHASE_I = "phase_i"
...
class OutputPaths:
    ...
    @property
    def phase_h_dir(self) -> Path:
        return phase_dir(self.root, PHASE_H)

    @property
    def phase_h_1_dir(self) -> Path:
        return self.phase_h_dir / PHASE_H_1_ENGINEERING_SPECIFICATIONS

    @property
    def phase_h_1_engineering_specifications_export(self) -> Path:
        return self.phase_h_1_dir / "engineering_specifications.json"

    @property
    def phase_h_1_specification_registry_export(self) -> Path:
        return self.phase_h_1_dir / "specification_registry.json"

    @property
    def phase_h_1_specification_summary_export(self) -> Path:
        return self.phase_h_1_dir / "specification_summary.json"

    @property
    def phase_h_1_specification_validation_export(self) -> Path:
        return self.phase_h_1_dir / "specification_validation.json"

    @property
    def phase_h_1_reference_contract_export(self) -> Path:
        return self.phase_h_1_dir / "reference_contract.json"

    @property
    def phase_h_1_specification_reference_validation_export(self) -> Path:
        return self.phase_h_1_dir / "specification_reference_validation.json"

    @property
    def phase_h_2_dir(self) -> Path:
        return self.phase_h_dir / PHASE_H_2_GEOMETRY_ASSOCIATION

    @property
    def phase_h_2_geometry_associations_export(self) -> Path:
        return self.phase_h_2_dir / "geometry_associations.json"

    @property
    def phase_h_2_geometry_registry_export(self) -> Path:
        return self.phase_h_2_dir / "geometry_registry.json"

    @property
    def phase_h_2_geometry_summary_export(self) -> Path:
        return self.phase_h_2_dir / "geometry_summary.json"

    @property
    def phase_h_2_geometry_validation_export(self) -> Path:
        return self.phase_h_2_dir / "geometry_validation.json"

    @property
    def phase_i_dir(self) -> Path:
        return phase_dir(self.root, PHASE_I)

    @property
    def phase_i_1_dir(self) -> Path:
        return self.phase_i_dir / PHASE_I_1_CALCULATION_CONTEXT

    @property
    def phase_i_1_calculation_contexts_export(self) -> Path:
        return self.phase_i_1_dir / "calculation_contexts.json"

    @property
    def phase_i_1_calculation_context_registry_export(self) -> Path:
        return self.phase_i_1_dir / "calculation_context_registry.json"

    @property
    def phase_i_1_calculation_context_summary_export(self) -> Path:
        return self.phase_i_1_dir / "calculation_context_summary.json"

    @property
    def phase_i_1_calculation_context_validation_export(self) -> Path:
        return self.phase_i_1_dir / "calculation_context_validation.json"

    @property
    def phase_i_2_dir(self) -> Path:
        return self.phase_i_dir / PHASE_I_2_REINFORCEMENT_ENGINE

    @property
    def phase_i_2_reinforcement_objects_export(self) -> Path:
        return self.phase_i_2_dir / "reinforcement_objects.json"

    @property
    def phase_i_2_reinforcement_registry_export(self) -> Path:
        return self.phase_i_2_dir / "reinforcement_registry.json"

    @property
    def phase_i_2_reinforcement_summary_export(self) -> Path:
        return self.phase_i_2_dir / "reinforcement_summary.json"

    @property
    def phase_i_2_reinforcement_validation_export(self) -> Path:
        return self.phase_i_2_dir / "reinforcement_validation.json"

    @property
    def phase_i_2_1_dir(self) -> Path:
        return self.phase_i_dir / PHASE_I_2_1_CALCULATION_READINESS

    @property
    def phase_i_2_1_reinforcement_readiness_export(self) -> Path:
        return self.phase_i_2_1_dir / "reinforcement_readiness.json"

    @property
    def phase_i_2_1_reinforcement_readiness_summary_export(self) -> Path:
        return self.phase_i_2_1_dir / "reinforcement_readiness_summary.json"

    @property
    def phase_i_2_1_reinforcement_readiness_validation_export(self) -> Path:
    ...
    def ensure_phase_h_subdirs(self) -> None:
        """Create Phase H root and H.1 / H.2 subfolders."""
        self.phase_h_dir.mkdir(parents=True, exist_ok=True)
        for subdir in (
            PHASE_H_1_ENGINEERING_SPECIFICATIONS,
            PHASE_H_2_GEOMETRY_ASSOCIATION,
        ):
            (self.phase_h_dir / subdir).mkdir(parents=True, exist_ok=True)

    def ensure_phase_i_subdirs(self) -> None:
        """Create Phase I root and I.1 / I.2 subfolders."""
        self.phase_i_dir.mkdir(parents=True, exist_ok=True)
        for subdir in (
    ...
    def ensure_phase_dirs(self) -> None:
        ...
        self.ensure_phase_h_subdirs()
        self.ensure_phase_i_subdirs()
