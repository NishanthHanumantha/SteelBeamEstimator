...
class W2SmokeTests(unittest.TestCase):
    ...
    def test_web_01_application_startup(self):
        ...
        self.assertIn("Version11", data["engine_root"].replace("\\", "/"))
        self.assertEqual(data["engine_label"], "Version11")
        ...
        self.assertIn("Version11 development pipeline", html)
    ...
    def test_web_05_and_06_adapter_invokes_version10_with_t1(self):
        self.assertEqual(config.ENGINE_ROOT.name, "Version11")
        ...
        self.assertIn("Version11", (status.get("engine_root") or "").replace("\\", "/"))
