...
**Tree:** Version9 — accuracy development (reinforcement ID & interpretation)

## Web / RunContext pipeline

```text
Upload DXFs
  → Version9/data/web_runs/<run_id>/{general_notes,framing,reinforcement}/
